...
export type MissionInfoDetailsQueryVariables = Exact<{
  id: Scalars['String'];
}>;


export type MissionInfoDetailsQuery = (
  { __typename?: 'Query' }
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'details' | 'launch_success' | 'launch_year' | 'mission_name'>
    & { rocket?: Maybe<(
      { __typename?: 'LaunchRocket' }
      & Pick<LaunchRocket, 'rocket_name'>
    )>, links?: Maybe<(
      { __typename?: 'LaunchLinks' }
      & Pick<LaunchLinks, 'flickr_images' | 'article_link'>
    )> }
  )> }
);
...
export const MissionInfoDetailsDocument = gql`
...
/**
 * __useMissionInfoDetailsQuery__
 *
 * To run a query within a React component, call `useMissionInfoDetailsQuery` and pass it any options that fit your needs.
 * When your component renders, `useMissionInfoDetailsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMissionInfoDetailsQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useMissionInfoDetailsQuery(baseOptions: Apollo.QueryHookOptions<MissionInfoDetailsQuery, MissionInfoDetailsQueryVariables>) {
        return Apollo.useQuery<MissionInfoDetailsQuery, MissionInfoDetailsQueryVariables>(MissionInfoDetailsDocument, baseOptions);
      }
export function useMissionInfoDetailsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MissionInfoDetailsQuery, MissionInfoDetailsQueryVariables>) {
          return Apollo.useLazyQuery<MissionInfoDetailsQuery, MissionInfoDetailsQueryVariables>(MissionInfoDetailsDocument, baseOptions);
        }
export type MissionInfoDetailsQueryHookResult = ReturnType<typeof useMissionInfoDetailsQuery>;
export type MissionInfoDetailsLazyQueryHookResult = ReturnType<typeof useMissionInfoDetailsLazyQuery>;
export type MissionInfoDetailsQueryResult = Apollo.QueryResult<MissionInfoDetailsQuery, MissionInfoDetailsQueryVariables>;